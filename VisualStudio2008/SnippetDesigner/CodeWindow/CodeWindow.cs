...
namespace Microsoft.SnippetDesigner
{
    ...
    public partial class CodeWindow : UserControl, ISnippetCodeWindow
    {
        ...
        public void HighlightSpan(TextSpan span, KindOfMarker markerType)
        {
            ...
            if (markerType == KindOfMarker.SnippetReplacement)
            {
                SnippetDesignerPackage.Instance.MarkerService.InsertMarker(PkgCmdIDList.cmdidSnippetReplacementMarker, span);
            }
            else if (markerType == KindOfMarker.ActiveSnippetReplacement)
            {
                SnippetDesignerPackage.Instance.MarkerService.InsertMarker(
                    PkgCmdIDList.cmdidActiveSnippetReplacementMarker, span);
            }
        }
